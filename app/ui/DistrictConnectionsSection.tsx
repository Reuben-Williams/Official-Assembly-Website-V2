...
function NewTabLabel() {
  return <span className={styles.newTab}>opens in a new tab</span>;
}

export async function DistrictConnectionsSection({ content }: { content: BuilderServerContent }) {
        ...
        <header className={styles.heading}>
          <div>
            <p className="eyebrow" data-builder-region="home.connections.eyebrow" data-builder-kind="text">
              {builderText(content, "home.connections.eyebrow", "Connect with District 34")}
            </p>
            <h2 data-builder-region="home.connections.title" data-builder-kind="text">
              {builderText(content, "home.connections.title", "Choose the right way to take part")}
            </h2>
          </div>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.actionColumn}>
            <article className={styles.connectionCard}>
              ...
              <p className={styles.kicker}>English · Español</p>
              <h3>{districtConnections.volunteer.title}</h3>
              <p>{districtConnections.volunteer.english}</p>
              <details className={styles.translation}>
                <summary>Leer en español</summary>
                <p lang="es">{districtConnections.volunteer.spanish}</p>
              </details>
              <a
            ...
            <article className={styles.connectionCard}>
              ...
              <p className={styles.kicker}>State Legislature</p>
              <h3>Contact your legislator</h3>
              <p>Send a legislative message through the contact form linked from the official New Jersey Legislature roster.</p>
              <a
                className={styles.primaryAction}
                ...
                rel="noopener noreferrer"
              >
                <span>Official Legislative Contact Form</span>
                <ArrowUpRight aria-hidden="true" />
              </a>
              <NewTabLabel />
              <a className={styles.phoneFallback} href={officialLegislatureProfile.office.phoneHref}>
                <Phone aria-hidden="true" />
                Call {officialLegislatureProfile.office.phoneDisplay}
              </a>
            </article>
          </div>
        </div>
