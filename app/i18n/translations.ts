...
Object.assign(spanishTranslations, {
  ...
  "Current District Resource": "Recurso actual del distrito",
  "Current office flyer and public information": "Volante actual de la oficina e información pública",
  "When the district office publishes a current resource flyer, it will appear here.": "Cuando la oficina del distrito publique un volante vigente de recursos, aparecerá aquí.",
  "No current district resource flyer is posted.": "No hay un volante vigente de recursos del distrito publicado.",
  "Use the verified resources below or contact the district office for current assistance.": "Use los recursos verificados a continuación o comuníquese con la oficina del distrito para recibir asistencia actualizada.",
  "Current District 34 public resource flyer": "Volante vigente de recursos públicos del Distrito 34",
  ...
  "Community Volunteer Portal": "Portal de voluntariado comunitario",
  "Assemblywoman Morales’ Community Volunteers": "Voluntariado comunitario de la asambleísta Morales",
  "Are you passionate about giving back to your community? I’m inviting you to join my team as a volunteer and help us make a real difference in the lives of our neighbors. From supporting outreach events, to connecting with our faith-based and small business communities, your time and energy will directly benefit the people of our district. Together, we can build stronger connections and ensure every voice is heard.": "¿Te apasiona retribuir a tu comunidad? Te invito a unirte a mi equipo como voluntario y ayudarnos a marcar una verdadera diferencia en la vida de nuestros vecinos. Desde apoyar en eventos comunitarios hasta conectar con organizaciones religiosas y pequeñas empresas, tu tiempo y energía beneficiarán directamente a las personas de nuestro distrito. Juntos, podemos fortalecer los lazos comunitarios y asegurarnos de que cada voz sea escuchada.",
  "This volunteer form is operated by Google Forms and opens in a new tab.": "Este formulario de voluntariado funciona mediante Google Forms y se abre en una pestaña nueva.",
  "Open volunteer form": "Abrir formulario de voluntariado",
  "Voting": "Elecciones",
  ...
  "Essex County Elections": "Elecciones del condado de Essex",
  "Start with the Essex County Clerk election hub for current county election information.": "Comience con el portal electoral del secretario del condado de Essex para consultar información electoral vigente del condado.",
  "Election Forms": "Formularios electorales",
  "Open the Essex County Clerk forms directory for official election documents.": "Abra el directorio de formularios del secretario del condado de Essex para consultar documentos electorales oficiales.",
  "Voter Registration": "Registro de votantes",
  "Use the Essex County Clerk voter registration service for county-specific guidance.": "Use el servicio de registro de votantes del secretario del condado de Essex para obtener orientación específica del condado.",
  "Vote by Mail": "Voto por correo",
  "Review the Essex County Clerk vote-by-mail service and official forms.": "Consulte el servicio de voto por correo y los formularios oficiales del secretario del condado de Essex.",
  "Sample Ballots": "Boletas de muestra",
  "Find available sample-ballot information through the Essex County Clerk.": "Encuentre la información disponible sobre boletas de muestra mediante el secretario del condado de Essex.",
  "State Voter Registration": "Registro estatal de votantes",
  "Visit the New Jersey Division of Elections for statewide registration and voter information.": "Visite la División de Elecciones de Nueva Jersey para obtener información estatal sobre el registro y los votantes.",
  "State Voter Information": "Información estatal para votantes",
  "New Jersey Election Guidance": "Orientación electoral de Nueva Jersey",
  "For statewide election guidance, use the Division of Elections contact and help resources.": "Para obtener orientación electoral estatal, use los recursos de contacto y ayuda de la División de Elecciones.",
  ...
  "Assemblywoman Carmen Morales gathered with Belleville residents at a Puerto Rican flag raising ceremony": "La asambleísta Carmen Morales junto a residentes de Belleville durante una ceremonia de izamiento de la bandera de Puerto Rico",
